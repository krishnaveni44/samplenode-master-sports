...
const INITIAL_MOVIE_LIST = [
  ...
  },
  {
    id: "105",
    name: "chess",
    poster: "https://5.imimg.com/data5/GE/PQ/MY-7330163/wooden-chess-set-with-medieval-design-pieces-mughal-army-1-500x500.jpg",
    rating: 8.6,
    summary:
      "The tournament will be conducted in Swiss-style in the initial rounds. In the initial rounds players will be paired randomly, so in case you unfortunately face the best player of the tournament in the first round and lose the first game, you still get a chance to recover in the subsequent rounds and reach the semis/final.",
    trailer: "https://www.youtube.com/embed/-wRdgOllrzM"
  },
  {
    id: "106",
    name: "motor racing",
    poster: "https://i.gadgets360cdn.com/large/best_android_games_main_1589521185888.jpg?downsize=950:*",
    rating: 8,
    summary:
  ...
  <div className = "App"> 
    ...
    <AppBar position="static">
        <Toolbar>
         ...
         <Button color="inherit" onClick = {() => history.push("/movies")}>Sports</Button>
